...
class MetaConfig:
    ...
    lambda_ewc: float = 1.0     # weight of zero-mean selectivity bias
                                # mean(M*(gA_hat^2-1)): close gates on
                                # A-sensitive weights, open on insensitive -
                                # level-neutral, direct valid gradient, no
                                # unroll needed
